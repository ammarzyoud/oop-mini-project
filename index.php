...
<?php
if ($num > 0) {
    echo "<h1 class='mt-3'>Products</h1>";
    echo "<table class='table table-hover table-responsive mt-3'>";
    echo "<tr>";
    echo "<th>Product</th>";
    echo "<th>Price</th>";
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "
                <a href='update_product.php?id={$id}' class='btn btn-info left-margin'>
                 ...
                 <a href='read_one_record.php?id={$id}' class='btn btn-primary left-margin'>
